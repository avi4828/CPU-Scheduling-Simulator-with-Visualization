...
export default function useSimulation() {
  ...
  // Fetch timeline and metrics from the backend server
  const fetchTimeline = useCallback(async () => {
    ...
    try {
      ...
      console.error('Failed to fetch CPU scheduling timeline from server:', error);
  ...
  }, [fetchTimeline, stepMode, speed, tick, isComplete, currentTime]);
